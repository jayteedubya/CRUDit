...
var initializeAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var addUsers = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users.createUser('jayteedubya', 'squirrels@nonsense.com', 'womprats!')];
            case 1:
                _a.sent();
                return [4 /*yield*/, users.createUser('SaltySeaDog', 'salty@sea.net', 'shite2222')];
            case 2:
                _a.sent();
                return [4 /*yield*/, users.createUser('H3ct1cB1rDZ3r0', 'raven@BiquadFilterNode.net', 'duck-sicker')];
            case 3:
                _a.sent();
                return [4 /*yield*/, posts.createPost('stuff', 'things', '1st', 'jayteedubya')];
            case 4:
                _a.sent();
                return [4 /*yield*/, comments.createComment('jayteedubya', 'this a comment, currently only available by direct SQL query.', 1)];
            case 5:
                _a.sent();
                return [2 /*return*/];
        }
